...
* можно проверить в списке и на карте http://orangespb.ru/shops/
...
## Шоколадница
	...
	amenity=cafe
	cuisine=coffee_shop
	website=http://shoko.ru/sankt-peterburg/
...
* можно проверить на карте http://shoko.ru/sankt-peterburg/adresa_kofeen/
* разные операторы
